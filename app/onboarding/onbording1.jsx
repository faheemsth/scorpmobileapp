...
const Onbording1 = () => {
  ...
  return (
    <ScrollView contentContainerStyle={{backgroundColor: '#7647EB'}}>
      ...
      <Pressable style={{display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center",marginTop:96,marginBottom:39.67,}}>
        <View style={{padding:23,backgroundColor:"#fff",borderRadius:1000,overflow:"hidden",}}>
        <Image style={{width:24,height:24,}} source={require("../../assets/Arroclk.png")} />
        </View>
      </Pressable>
