    ...
    <ScrollView contentContainerStyle={{flex: 1, gap: 10}}>
      ...
      <View style={{padding: 20}}>
        <View>
          ...
          <InputField style={{marginHorizontal: 0}} readonly={true} value={user?.["name"]} />
        </View>
        <View>
          <Text styles={[styles.font(400), {marginLeft: 10}]}>Email</Text>
          <InputField style={{marginHorizontal: 0}} readonly={true} value={user?.["email"]} />
        </View>
        <View>
          <Text styles={[styles.font(400), {marginLeft: 10}]}>Phone Number</Text>
          <InputField style={{marginHorizontal: 0}} readonly={true} value={user?.["phone"]} />
        </View>
        <View>
          <Text styles={[styles.font(400), {marginLeft: 10}]}>Designation</Text>
          <InputField style={{marginHorizontal: 0}} readonly={true} value={user?.["type"]} />
        </View>
